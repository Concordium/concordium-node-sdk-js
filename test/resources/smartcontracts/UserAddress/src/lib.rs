...
#[init(contract = "UserAddress", parameter = "AccountAddress")]
...
#[receive(contract = "UserAddress", name = "insertAmount", payable, parameter = "u8")]
...
#[receive(contract = "UserAddress", name = "smashAmount")]

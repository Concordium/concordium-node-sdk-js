...
export class Carousel {
    ...
    private updateCarousel(index: number, smooth: boolean = true): void {
        ...
        if (this.track) {
            this.track.style.transition = smooth ? `transform ${this.options.transitionDuration}ms ease-out` : 'none';
            this.track.style.transform = `translateX(${offset}%)`;
        }
...
export function createCarousel(container: HTMLElement, options: CarouselOptions = {}): Carousel {

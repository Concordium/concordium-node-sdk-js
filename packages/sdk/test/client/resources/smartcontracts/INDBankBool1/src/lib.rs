...
#[init(contract = "INDBankBool1", parameter = "bool")]
...
#[receive(contract = "INDBankBool1", name = "insertAmount", payable, parameter = "u8")]
...
/// Insert some GTU into a dcb bank, allowed by anyone.
#[receive(contract = "INDBankBool1", name = "insertAmount1", payable, parameter = "u16")]
...
/// Insert some GTU into a dcb bank, allowed by anyone.
#[receive(contract = "INDBankBool1", name = "insertAmount2", payable, parameter = "u32")]
...
/// Insert some GTU into a dcb bank, allowed by anyone.
#[receive(contract = "INDBankBool1", name = "insertAmount3", payable, parameter = "u64")]
...
/// Insert some GTU into a dcb bank, allowed by anyone.
#[receive(contract = "INDBankBool1", name = "insertAmount4", payable, parameter = "i8")]
...
/// Insert some GTU into a dcb bank, allowed by anyone.
#[receive(contract = "INDBankBool1", name = "insertAmount5", payable, parameter = "i16")]
...
/// Insert some GTU into a dcb bank, allowed by anyone.
#[receive(contract = "INDBankBool1", name = "insertAmount6", payable, parameter = "i32")]
...
/// Insert some GTU into a dcb bank, allowed by anyone.
#[receive(contract = "INDBankBool1", name = "insertAmount7", payable, parameter = "i64")]
...
#[receive(contract = "INDBankBool1", name = "smashAmount")]

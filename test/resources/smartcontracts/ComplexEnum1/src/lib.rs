...
#[init(contract = "ComplexEnum1",  parameter = "Message")]
...
#[receive(contract = "ComplexEnum1", name = "insertAmount", payable, parameter = "DCBBankState")]
...
#[receive(contract = "ComplexEnum1", name = "smashAmount")]

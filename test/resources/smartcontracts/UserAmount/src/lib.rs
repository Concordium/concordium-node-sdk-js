...
#[init(contract = "UserAmount", parameter = "Amount")]
...
#[receive(contract = "UserAmount", name = "insertAmount", payable, parameter = "u8")]
...
#[receive(contract = "UserAmount", name = "smashAmount")]

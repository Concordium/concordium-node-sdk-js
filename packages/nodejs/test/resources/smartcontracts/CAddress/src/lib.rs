...
#[init(contract = "CAddress", parameter = "ContractAddress")]
...
#[receive(contract = "CAddress", name = "insertAmount", payable, parameter = "u8")]
...
#[receive(contract = "CAddress", name = "smashAmount")]

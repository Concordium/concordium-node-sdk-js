...
import { ConcordiumGRPCClient, ConcordiumGRPCWebClient, IdentityInput } from '../../src/index.js';
import { ConcordiumGRPCNodeClient } from '../../src/nodejs/grpc.js';
import { EncryptedData, MobileWalletExport, decryptMobileWalletExport } from '../../src/nodejs/index.js';
 ...
 */
export function getNodeClientV2(address = TESTNET_NODE, port = GRPCV2_PORT): ConcordiumGRPCClient {
    return new ConcordiumGRPCNodeClient(address, port, credentials.createInsecure(), {
        timeout: 15000,
    });
}
...
export function getIdentityInput(): IdentityInput {
    const rawData = fs.readFileSync('./test/client/resources/mobileWalletExport.json', 'utf8');

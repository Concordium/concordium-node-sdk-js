...
#[init(contract = "SimpleEnum",  parameter = "DCBBankState")]
...
#[receive(contract = "SimpleEnum", name = "insertAmount", payable, parameter = "u8")]
...
#[receive(contract = "SimpleEnum", name = "smashAmount")]

import { AccountAddress, CIS2, CIS2Contract, ContractAddress, EntrypointName } from '@concordium/web-sdk';
...
(async () => {
    ...
    const to: CIS2.Receiver = AccountAddress.instanceOf(toAddress)
        ...
        : {
              address: toAddress,
              hookName: EntrypointName.fromString(cli.flags.receiveHookName ?? ''),
          };

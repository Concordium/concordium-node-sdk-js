...
export const isAuthorizationsV1 = (
    as: Authorizations
): as is AuthorizationsV1 => as.version === 1;
...
export const isChainParametersV0 = (
    cp: ChainParameters
): cp is ChainParametersV0 => cp.version === 0;
...
export const isChainParametersV1 = (
    cp: ChainParameters
): cp is ChainParametersV1 => cp.version === 1;
...
export const isChainParametersV2 = (
    cp: ChainParameters
): cp is ChainParametersV2 => cp.version === 2;
...
export const isConsensusStatusV0 = (
    cs: ConsensusStatus
): cs is ConsensusStatusV0 => cs.version === 0;
...
export const isConsensusStatusV1 = (
    cs: ConsensusStatus
): cs is ConsensusStatusV1 => cs.version === 1;

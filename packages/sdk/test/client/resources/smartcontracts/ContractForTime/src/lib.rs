...
#[init(contract = "ContractForTime", parameter = "Timestamp")]
...
#[receive(contract = "ContractForTime", name = "insertAmount", payable, parameter = "u8")]
...
#[receive(contract = "ContractForTime", name = "smashAmount")]

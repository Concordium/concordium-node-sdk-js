...
assert(result.summary.type === TransactionSummaryType.AccountTransaction);

switch (result.summary.transactionType) {
    case TransactionKindString.TokenUpdate:
        result.summary.events.forEach(console.log);
        break;

import { AccountAddress, AccountInfo, SimpleAccountKeys, buildAccountSigner } from '../../src/index.js';
import { buildBasicAccountSigner, signMessage, verifyMessageSignature } from '../../src/signHelpers.js';
...
testEachMessageType('[%o] verifyMessageSignature returns true on the correct address/signature', async (message) => {

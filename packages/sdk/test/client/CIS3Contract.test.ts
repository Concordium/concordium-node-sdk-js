...
const SPONSOR = AccountAddress.fromBase58(
    '3CnwP3DcvYdzHsjpU1Xme2sUS3ATK5qk2W7gi945vierMfLT7W'
);
const SPONSOREE_KEY =
    '6fb89ee03ea03d038ba0bfa62dbc29eec6f30b154f797cfa5c296beb1c178428';
...
describe('permit', () => {
    ...
    test('Manual serialization matches schema serialization', async () => {
        ...
        const tx = contract.createPermit(
...
describe('supportsPermit', () => {
    test('Deserializes correctly', async () => {
        ...
        const transferRes = await contract.supportsPermit(
            EntrypointName.fromString('transfer'),
            TEST_BLOCK
        );
        expect(transferRes).toBe(true);

        const mintRes = await contract.supportsPermit(

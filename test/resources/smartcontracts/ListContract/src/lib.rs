...
#[init(contract = "ListContract",  parameter = "Tokens")]
...
#[receive(contract = "ListContract", name = "insertAmount", payable, parameter = "u8")]
...
#[receive(contract = "ListContract", name = "smashAmount")]
